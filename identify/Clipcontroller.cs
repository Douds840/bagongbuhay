...
public class QuizManager : MonoBehaviour
{
    ...
    [SerializeField] private GameObject gameCompletePanel; // Reference to the Game Complete panel
    ...
    void Start()
    {
        ...
        // Hide the restart button and panels initially
    ...
    void RestartQuiz()
    {
        ...
        // Hide the restart button and panels
        restartButton.gameObject.SetActive(false);
        gameCompletePanel.SetActive(false);
        gameOverPanel.SetActive(false);
